        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtensiveInformation = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignUsers", x => new { x.CampaignId, x.PlayersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CampaignUsers_Users_PlayersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignUsers_PlayersId",
                table: "CampaignUsers",
                column: "PlayersId");
        }
